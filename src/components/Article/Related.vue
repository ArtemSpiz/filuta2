...
<template>
  <div class="container gap-[48px] flex-col">
    <div class="flex justify-between items-center max-md:center">
      ...
      <router-link to="/blog" class="max-md:hidden">
        <button
          class="h-[48px] px-[20px] gap-[8px] center flex rounded-full border border-white bg-[rgba(255,255,255,0.02)] text-white text-[16px] font-ibm"
        >
    ...
    <router-link to="/blog" class="hidden center max-md:flex">
      <button
        class="h-[48px] px-[20px] gap-[8px] center flex rounded-full border border-white bg-[rgba(255,255,255,0.02)] text-white text-[16px] font-ibm"
      >
