...
<template>
  <div
    class="container relative items-center flex-col help pb-0 max-lg:pb-0 max-md:gap-[32px]"
  >
    <div
    ...
    <div class="flex flex-col items-center gap-[16px] helpText">
      ...
      <div class="Subtitle text-center max-w-[680px]">
        Testing modern infotainment systems can be complex and time-intensive,
        especially with growing feature sets and integration requirements.
    ...
    <div class="flex flex-col gap-[18px] self-stretch z-10 relative">
      ...
      >
        ...
        >
          ...
          <div
            class="w-full max-w-[587px] max-md:max-w-[400px] max-sm:max-w-[293px]"
          >
